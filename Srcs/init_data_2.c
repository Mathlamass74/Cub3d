...
/*   Updated: 2024/10/30 13:36:20 by pcardin          ###   ########.fr       */
/*                                                                            */
/* ************************************************************************** */
...
void	init_doors(t_data *d)
{
	...
	{
		printf(\
		"Erreur : impossible d'allouer la mémoire pour la structure move\n");
		exit(EXIT_FAILURE);
	}
	...
	{
		printf(\
		"Erreur : impossible d'allouer la mémoire pour la structure sdoor\n");
		exit(EXIT_FAILURE);
	}
	d->sdoor->x = 0;
	d->sdoor->y = 0;
